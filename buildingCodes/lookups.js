...
export const nonResidentialBuildingCodes = {
    ...
    '610': {
        codeName: 'Government legislative and administration building other than office building',
        examples: [
            'city hall',
            'court of justice',
            'embassy',
    ...
    '630': {
        codeName: 'Library, museum, art gallery, aquarium, botanical garden, archive building, scientific center',
        examples: []
    },
    '640': {
        codeName: 'Hospital',
    ...
    '650': {
        codeName: 'Day care, nursing home, rest home, home for the blind, charitable home, detoxification center',
        examples: []
    },
    '660': {
